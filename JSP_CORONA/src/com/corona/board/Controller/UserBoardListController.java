 ...
 */
@WebServlet(urlPatterns= {"/UserBoardList","/corona/MainMenu/UserBoardList"})
...
//		response.sendRedirect(request.getContextPath()+"/corona/MainMenu/Board.jsp");
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/corona/MainMenu/UserBoard.jsp");
