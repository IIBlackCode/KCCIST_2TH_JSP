...
<body class="is-preload">
   ...
   <section id="banner">
    ...
    <section id="main" class="wrapper">
		<div class="inner" style="overflow:scroll; width:90%; height:550px;">
		<div class="content">
		<header>
			<h2>CHATTING</h2>
		</header>
		...
		<%if (member == null){ %>
			<input type="hidden" value=<%=request.getRemoteAddr() %> id='chat_id' />
		<%}else{ %>		
			<input type="hidden" value=<%=member.getMember_id() %> id='chat_id' />
		<%} %>
		<!--     채팅창 -->
